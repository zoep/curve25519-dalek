...
impl<'b> AddAssign<&'b FieldElement51> for FieldElement51 {
    fn add_assign(&mut self, _rhs: &'b FieldElement51) {
        unsafe {
            fiat_25519_add(&mut self.0[0], &self.0[0], &_rhs.0[0]);
            fiat_25519_carry(&mut self.0[0], &self.0[0]);
        }
    }
}
...
impl<'a, 'b> Add<&'b FieldElement51> for &'a FieldElement51 {
    ...
    fn add(self, _rhs: &'b FieldElement51) -> FieldElement51 {
        let mut output = *self;
        unsafe {
            fiat_25519_add(&mut output.0[0], &self.0[0], &_rhs.0[0]);
            fiat_25519_carry(&mut output.0[0], &output.0[0]);
        }
        output
    }
}
...
impl<'b> SubAssign<&'b FieldElement51> for FieldElement51 {
    fn sub_assign(&mut self, _rhs: &'b FieldElement51) {
        unsafe {
            fiat_25519_sub(&mut self.0[0], &self.0[0], &_rhs.0[0]);
            fiat_25519_carry(&mut self.0[0], &self.0[0]);
        }
    }
}
...
impl<'a, 'b> Sub<&'b FieldElement51> for &'a FieldElement51 {
    ...
    fn sub(self, _rhs: &'b FieldElement51) -> FieldElement51 {
        let mut output = *self;
        unsafe {
            fiat_25519_sub(&mut output.0[0], &self.0[0], &_rhs.0[0]);
            fiat_25519_carry(&mut output.0[0], &output.0[0]);
        }
        output
    }
...
impl<'b> MulAssign<&'b FieldElement51> for FieldElement51 {
    fn mul_assign(&mut self, _rhs: &'b FieldElement51) {
        unsafe {
            fiat_25519_carry_mul(&mut self.0[0], &self.0[0], &_rhs.0[0]);
        }
    }
}
...
impl<'a, 'b> Mul<&'b FieldElement51> for &'a FieldElement51 {
    ...
    fn mul(self, _rhs: &'b FieldElement51) -> FieldElement51 {
        let mut output = *self;
        unsafe {
            fiat_25519_carry_mul(&mut output.0[0], &self.0[0], &_rhs.0[0]);
        }
        output
    }
}
...
impl<'a> Neg for &'a FieldElement51 {
    ...
    fn neg(self) -> FieldElement51 {
        let mut output = *self;
        unsafe {
            fiat_25519_opp(&mut output.0[0], &self.0[0]);
            fiat_25519_carry(&mut output.0[0], &output.0[0]);
        }
        output
    }
...
impl ConditionallySelectable for FieldElement51 {
    fn conditional_select(
        ...
        unsafe {
            fiat_25519_selectznz(&mut output[0], choice.unwrap_u8() as fiat_25519_uint1, &a.0[0], &b.0[0]);
        }
...
impl FieldElement51 {
    ...
    fn reduce(mut limbs: [u64; 5]) -> FieldElement51 {
        unsafe {
            fiat_25519_carry(&mut limbs[0], &limbs[0]);
        }
    ...
    pub fn from_bytes(bytes: &[u8; 32]) -> FieldElement51 {
        ...
        let mut output = [0u64; 5];
        unsafe {
            fiat_25519_from_bytes(&mut output[0], &temp[0]);
        }
        FieldElement51(output)
    }
    ...
    pub fn to_bytes(&self) -> [u8; 32] {
        ...
        unsafe {
            fiat_25519_to_bytes(&mut bytes[0], &self.0[0]);
        }
        return bytes;
    }
    ...
    pub fn pow2k(&self, mut k: u32) -> FieldElement51 {
        ...
        unsafe {
        loop {
                fiat_25519_carry_square(&mut output.0[0], &output.0[0]);
                k -= 1;
            if k == 0 {
                    return output;
                }
    ...
    pub fn square(&self) -> FieldElement51 {
        let mut output = *self;
        unsafe {
            fiat_25519_carry_square(&mut output.0[0], &self.0[0]);
        }
        output
    }
    ...
    pub fn square2(&self) -> FieldElement51 {
        ...
        unsafe {
            let mut temp = *self;
            fiat_25519_carry_square(&mut temp.0[0], &self.0[0]);
            fiat_25519_add(&mut output.0[0], &temp.0[0], &temp.0[0]);
            fiat_25519_carry(&mut output.0[0], &output.0[0]);
        }
        output
    }
